...
const TEMPLATES = {
  ...
  'payment.voucher': (ctx) => ({
    ...
    html: `
      ...
      <p style="color:#6B7280;font-size:13px;margin-top:20px">Este acuse de recibo no reemplaza la boleta/factura electrónica del SII, que enviamos al correo de facturación en un segundo paso.</p>
    `
  }),
